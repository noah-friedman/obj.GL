...
/**
 * Single function to get a WebGL context and generate a program from shaders.
 ...
 * @param fragmentShader The source for the fragement shader to be used in the WebGL program.
